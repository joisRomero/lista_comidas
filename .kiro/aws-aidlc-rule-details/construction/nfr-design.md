...
- **Security Patterns** - Only if security implementation approach needs input. **ISO 27001 Alignment**: When designing security patterns, reference applicable ISO 27001 controls from the Inception assessment (`aidlc-docs/inception/iso-27001/iso-27001-assessment.md`). Ensure design patterns address the security considerations identified for this project.
